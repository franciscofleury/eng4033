...
print("FRANCISCO MEIRELLES FLEURY")
...
distancia = 1280.4 * 1.60934
print("A distancia entre NY e Miami é de %.2f km" % distancia)
...
pais4 = {"nome": "Russia", "capital": "Moscow", "populacao": 523592839, "democracia": False}
...
for pais in lista_de_paises:
    print("%s é um país com %d habitantes cujo governo %s uma democracia." % (pais["nome"], pais["populacao"], "é" if pais["democracia"] else "não é"))
